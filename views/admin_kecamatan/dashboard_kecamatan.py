...
class DashboardKecamatan(ctk.CTkFrame):
    ...
    def __init__(self, parent, app, **kwargs):
        ...
        sidebar = Sidebar(self, app=app, menu_items=[
            ...
            {"icon": "🔄", "label": "Refresh", "command": lambda: self._refresh_data()},
        ])
        ...
        # Header
        ctk.CTkLabel(
            content, text=f"📋  Dashboard Kecamatan {self.kecamatan}",
        ...
        self.table = DataTable(
            ...
            columns=[
                ...
                {"key": "judul", "label": "Judul", "width": 170, "max_len": 28},
                {"key": "nama_pelapor", "label": "Pelapor", "width": 120, "max_len": 18},
                {"key": "kelurahan", "label": "Kelurahan", "width": 120, "max_len": 18},
                {"key": "kategori", "label": "Kategori", "width": 120, "max_len": 16},
                {"key": "status", "label": "Status", "width": 140, "max_len": 22},
                {"key": "created_at", "label": "Tanggal", "width": 120},
            ],
    ...
    def _on_select(self, laporan: dict):
        ...
        info = (f"Pelapor: {laporan.get('nama_pelapor', '')}  |  "
                f"Kelurahan: {laporan.get('kelurahan', '')}  |  "
